...
Чтобы расширить агента — добавляй правила/ссылки в handbook (модерация, стратегии, форматы объявлений). Полный автопарсинг всего `support/direct` не нужен: лучше курируемые блоки под РСЯ/арбитраж.
