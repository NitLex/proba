...
export const DIRECT_HARD_RULES = [
  ...
  'Финансовые/платёжные услуги: нейтральные формулировки + готовность загрузить документы в чат модерации.',
...
export function buildDirectOperatorChecklist({ plan, offer, playbook } = {}) {
  ...
  const items = [
    ...
    },
    {
      id: 'docs_if_needed',
      text: fin
        ? 'Фин/платежи: подготовь лицензию/свидетельство ЦБ (если потребуют) и загрузи в чат модерации'
