    ...
    <div className="page">
      <header className="page-head">
        <div>
          ...
          <p className="muted">
            Локальный оркестратор. Анализ — <strong>глобальный рынок</strong> (сеть, Wordstat, чужие связки по вертикали), не только наши сайты.
            Прод <code>trekerarbitrag.ru</code> — только трекер; оркестратор туда не деплоим.
          </p>
        </div>
      </header>
